...
class TutorialScreenWidget extends StatefulWidget {
  const TutorialScreenWidget({Key key}) : super(key: key);

  @override
  _TutorialScreenWidgetState createState() => _TutorialScreenWidgetState();
}

class _TutorialScreenWidgetState extends State<TutorialScreenWidget> {
